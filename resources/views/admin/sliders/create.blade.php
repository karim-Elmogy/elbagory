...
@section('title', 'إضافة Slider جديد')

@section('content')
<div class="page-header d-flex justify-content-between align-items-center">
    <h1><i class="fas fa-plus"></i> إضافة Slider جديد</h1>
...
<form method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="background_color" class="form-control form-control-color" 
                               value="{{ old('background_color', '#404553') }}" required>
                        <input type="text" name="background_color_text" class="form-control mt-2" 
                               value="{{ old('background_color', '#404553') }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <select name="text_color" class="form-select">
                            ...
                            <option value="light" {{ old('text_color') == 'light' ? 'selected' : '' }}>فاتح (أبيض)</option>
                            <option value="dark" {{ old('text_color') == 'dark' ? 'selected' : '' }}>داكن (أسود)</option>
                        </select>
                        @error('text_color')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
            ...
            <div class="card shadow-sm mt-3">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">صورة الـ Slider</label>
    ...
    <div class="mt-4 text-end">
        <button type="submit" class="btn btn-primary btn-lg">
            <i class="fas fa-save"></i> حفظ الـ Slider
        </button>
